...
const CreateJob: NextPage = () => {
  return (
    <div className="relative bg-white w-full h-[1755px] overflow-hidden text-left text-sm text-darkslategray-700 font-poppins">
      ...
      <div className="absolute top-[952px] left-[1080px] w-[360px] h-[45px] text-center text-base text-white">
      ...
      <div className="absolute top-[24px] left-[0px] w-[1920px] h-[68px] text-darkslategray-100">
        <Image
          className="absolute top-[67px] left-[0px] w-[1920px] h-px opacity-[0.1] mix-blend-normal"
          width={1920}
          height={1}
          alt=""
          src="/line-21.svg"
      ...
      <div className="absolute top-[1215px] left-[1080px] w-[289px] h-[423px] overflow-hidden">
        ...
        <Image
          className="absolute h-[4.73%] w-[6.92%] top-[10.17%] right-[93.08%] bottom-[85.11%] left-[0%] max-w-full overflow-hidden max-h-full"
          width={20}
          height={20}
          alt=""
          src="/checked-3.svg"
      ...
      <div className="absolute top-[644px] left-[1083px] w-[360px] h-[594px] overflow-hidden">
        ...
        <b className="absolute top-[calc(50%_-_264px)] left-[3.89%] leading-[46px]">
          <p className="m-0">N/A</p>
          <p className="m-0">{`1 Years `}</p>
          <p className="m-0">2 Years</p>
          <p className="m-0">3 Years</p>
          <p className="m-0">4 Years</p>
          <p className="m-0">5 Years</p>
          <p className="m-0">6 Years</p>
          <p className="m-0">7 Years</p>
          <p className="m-0">8 Years</p>
          <p className="m-0">9 Years</p>
          <p className="m-0">10 Years</p>
          <p className="m-0">More then 10 Years</p>
        </b>
        <div className="absolute top-[calc(50%_-_285px)] left-[3.89%] text-xs opacity-[0.4] mix-blend-normal">
          Experience Required
        </div>
        <div className="absolute top-[calc(50%_-_285px)] left-[91.67%] text-xl font-material-icons text-black">
          
        </div>
      </div>
