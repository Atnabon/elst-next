...
const JobDetails2: NextPage = () => {
  return (
    <div className="relative bg-white w-full h-[1844px] overflow-hidden text-left text-sm text-darkslategray-700 font-poppins">
      ...
      <div className="absolute top-[852px] left-[1080px] w-[360px] h-[166px] overflow-hidden">
        ...
        <b className="absolute top-[calc(50%_-_55px)] left-[3.89%] leading-[46px]">
          <p className="m-0">Per Hour</p>
          <p className="m-0">Per Week</p>
          <p className="m-0">Per Month</p>
        </b>
        <div className="absolute top-[calc(50%_-_71px)] left-[3.89%] text-xs opacity-[0.4] mix-blend-normal">
          Contract Type
        </div>
        <div className="absolute top-[calc(50%_-_71px)] left-[92.78%] text-xl font-material-icons text-black">
          
        </div>
      </div>
      <div className="absolute top-[1048px] left-[1080px] w-[338px] h-[243px] overflow-hidden">
      ...
      <div className="absolute top-[1318px] left-[1080px] w-[289px] h-[423px] overflow-hidden">
